 ...
 * generated in the web_service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://web_service/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://web_service/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web_service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web_service/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web_service/", name = "queryWeatherResponse")
